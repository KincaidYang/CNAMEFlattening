...
func main() {
	...
	recordLines := []string{
		...
		// 铁通
		"辽宁铁通", "吉林铁通", "黑龙江铁通", "北京铁通", "河北铁通", "山西铁通", "内蒙铁通", "天津铁通", "上海铁通", "江苏铁通",
		"浙江铁通", "安徽铁通", "福建铁通", "江西铁通", "山东铁通", "河南铁通", "湖北铁通", "湖南铁通", "广东铁通", "广西铁通",
		"海南铁通", "重庆铁通", "四川铁通", "贵州铁通", "云南铁通", "西藏铁通", "陕西铁通", "甘肃铁通", "青海铁通", "宁夏铁通", "新疆铁通",
		// 教育网
		"辽宁教育网", "吉林教育网", "黑龙江教育网", "北京教育网", "河北教育网", "山西教育网", "内蒙教育网", "天津教育网", "上海教育网", "江苏教育网",
	...
	dnsIPs := []string{
		...
		DNS_HAINAN_CTT, DNS_CHONGQING_CTT, DNS_SICHUAN_CTT, DNS_GUIZHOU_CTT, DNS_YUNNAN_CTT, DNS_XIZANG_CTT, DNS_SHAANXI_CTT, DNS_GANSU_CTT, DNS_QINGHAI_CTT, DNS_NINGXIA_CTT,
		// 教育网
		...
		DNS_HAINAN_EDU, DNS_CHONGQING_EDU, DNS_SICHUAN_EDU, DNS_GUIZHOU_EDU, DNS_YUNNAN_EDU, DNS_XIZANG_EDU, DNS_SHAANXI_EDU, DNS_GANSU_EDU, DNS_QINGHAI_EDU, DNS_NINGXIA_EDU,
		// 默认
		DNS_SHANGHAI_CT,
