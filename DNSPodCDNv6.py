...
# URL为 DNSPod DOH接口地址，用以获取CDN实时解析情况，可自行替换（DNSPod DoH获取IPv6存在问题，临时替换为阿里DoH）
...
ip1_LIAONING_CU= result_LIAONING_CU['Answer'][1]['data']
ip2_LIAONING_CU= result_LIAONING_CU['Answer'][2]['data']
# 获取辽宁联通记录ID
try:
    ...
    RecordId_LIAONING_CU2 = result_LIAONING_CU_RecordId['RecordList'][1]['RecordId']
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_LIAONING_CU2,
        "RecordType": record_type,
        "RecordLine": "辽宁联通",
        "Value": ip2_LIAONING_CU
    }
    req.from_json_string(json.dumps(params))
    resp_DONGBEI_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_DONGBEI_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 辽宁电信
# 获取辽宁电信 CDN 调度结果
...
# 考虑到 CDN 存在多级CNAME，故从第二个data开始取值，保险起见仅取两值
ip1_LIAONING_CT= result_LIAONING_CT['Answer'][1]['data']
ip2_LIAONING_CT= result_LIAONING_CT['Answer'][2]['data']
# 获取辽宁电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_LIAONING_CT2 = result_LIAONING_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新辽宁电信记录
# 更新辽宁电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_LIAONING_CT2,
        "RecordType": record_type,
        "RecordLine": "辽宁电信",
        "Value": ip2_LIAONING_CT
    }
    req.from_json_string(json.dumps(params))
    resp_DONGBEI_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_DONGBEI_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 辽宁移动
# 获取辽宁移动 CDN 调度结果
...
# 考虑到 CDN 存在多级CNAME，故从第二个data开始取值，保险起见仅取两值
ip1_LIAONING_CM= result_LIAONING_CM['Answer'][1]['data']
ip2_LIAONING_CM= result_LIAONING_CM['Answer'][2]['data']
# 获取辽宁移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_LIAONING_CM2 = result_LIAONING_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新辽宁移动记录
# 更新辽宁移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_LIAONING_CM2,
        "RecordType": record_type,
        "RecordLine": "辽宁移动",
        "Value": ip2_LIAONING_CM
    }
    req.from_json_string(json.dumps(params))
    resp_DONGBEI_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_DONGBEI_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 吉林
# 吉林联通
...
# 考虑到 CDN 存在多级CNAME，故从第二个data开始取值，保险起见仅取两值
ip1_JILIN_CU= result_JILIN_CU['Answer'][1]['data']
ip2_JILIN_CU= result_JILIN_CU['Answer'][2]['data']
# 获取吉林联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_JILIN_CU2 = result_JILIN_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新吉林联通记录
# 更新吉林联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_JILIN_CU2,
        "RecordType": record_type,
        "RecordLine": "吉林联通",
        "Value": ip2_JILIN_CU
    }
    req.from_json_string(json.dumps(params))
    resp_JILIN_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_JILIN_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 吉林电信
# 获取吉林电信 CDN 调度结果
...
# 考虑到 CDN 存在多级CNAME，故从第二个data开始取值，保险起见仅取两值
ip1_JILIN_CT= result_JILIN_CT['Answer'][1]['data']
ip2_JILIN_CT= result_JILIN_CT['Answer'][2]['data']
# 获取吉林电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_JILIN_CT2 = result_JILIN_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新吉林电信记录
# 更新吉林电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_JILIN_CT2,
        "RecordType": record_type,
        "RecordLine": "吉林电信",
        "Value": ip2_JILIN_CT
    }
    req.from_json_string(json.dumps(params))
    resp_JILIN_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_JILIN_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 吉林移动
# 获取吉林移动 CDN 调度结果
...
# 考虑到 CDN 存在多级CNAME，故从第二个data开始取值，保险起见仅取两值
ip1_JILIN_CM= result_JILIN_CM['Answer'][1]['data']
ip2_JILIN_CM= result_JILIN_CM['Answer'][2]['data']
# 获取吉林移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_JILIN_CM2 = result_JILIN_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新吉林移动记录
# 更新吉林移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_JILIN_CM2,
        "RecordType": record_type,
        "RecordLine": "吉林移动",
        "Value": ip2_JILIN_CM
    }
    req.from_json_string(json.dumps(params))
    resp_JILIN_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_JILIN_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 黑龙江
# 黑龙江联通
...
# 考虑到 CDN 存在多级CNAME，故从第二个data开始取值，保险起见仅取两值
ip1_HEILONGJIANG_CU= result_HEILONGJIANG_CU['Answer'][1]['data']
ip2_HEILONGJIANG_CU= result_HEILONGJIANG_CU['Answer'][2]['data']
# 获取黑龙江联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_HEILONGJIANG_CU2 = result_HEILONGJIANG_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新黑龙江联通记录
# 更新黑龙江联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_HEILONGJIANG_CU2,
        "RecordType": record_type,
        "RecordLine": "黑龙江联通",
        "Value": ip2_HEILONGJIANG_CU
    }
    req.from_json_string(json.dumps(params))
    resp_HEILONGJIANG_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_HEILONGJIANG_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 黑龙江电信
# 获取黑龙江电信 CDN 调度结果
...
# 考虑到 CDN 存在多级CNAME，故从第二个data开始取值，保险起见仅取两值
ip1_HEILONGJIANG_CT= result_HEILONGJIANG_CT['Answer'][1]['data']
ip2_HEILONGJIANG_CT= result_HEILONGJIANG_CT['Answer'][2]['data']
# 获取黑龙江电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_HEILONGJIANG_CT2 = result_HEILONGJIANG_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新黑龙江电信记录
# 更新黑龙江电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_HEILONGJIANG_CT2,
        "RecordType": record_type,
        "RecordLine": "黑龙江电信",
        "Value": ip2_HEILONGJIANG_CT
    }
    req.from_json_string(json.dumps(params))
    resp_HEILONGJIANG_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_HEILONGJIANG_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 黑龙江移动
# 获取黑龙江移动 CDN 调度结果
...
# 考虑到 CDN 存在多级CNAME，故从第二个data开始取值，保险起见仅取两值
ip1_HEILONGJIANG_CM= result_HEILONGJIANG_CM['Answer'][1]['data']
ip2_HEILONGJIANG_CM= result_HEILONGJIANG_CM['Answer'][2]['data']
# 获取黑龙江移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_HEILONGJIANG_CM2 = result_HEILONGJIANG_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新黑龙江移动记录
# 更新黑龙江移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_HEILONGJIANG_CM2,
        "RecordType": record_type,
        "RecordLine": "黑龙江移动",
        "Value": ip2_HEILONGJIANG_CM
    }
    req.from_json_string(json.dumps(params))
    resp_HEILONGJIANG_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_HEILONGJIANG_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 北京
# 北京联通
...
# 考虑到 CDN 存在多级CNAME，故从第二个data开始取值，保险起见仅取两值
ip1_BEIJING_CU= result_BEIJING_CU['Answer'][1]['data']
ip2_BEIJING_CU= result_BEIJING_CU['Answer'][2]['data']
# 获取北京联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_BEIJING_CU2 = result_BEIJING_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新北京联通记录
# 更新北京联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_BEIJING_CU2,
        "RecordType": record_type,
        "RecordLine": "北京联通",
        "Value": ip2_BEIJING_CU
    }
    req.from_json_string(json.dumps(params))
    resp_BEIJING_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_BEIJING_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 北京电信
# 获取北京电信 CDN 调度结果
...
# 考虑到 CDN 存在多级CNAME，故从第二个data开始取值，保险起见仅取两值
ip1_BEIJING_CT= result_BEIJING_CT['Answer'][1]['data']
ip2_BEIJING_CT= result_BEIJING_CT['Answer'][2]['data']
# 获取北京电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_BEIJING_CT2 = result_BEIJING_CT_RecordId['RecordList'][1]['RecordId']  
except TencentCloudSDKException as err:
    print(err)
# 更新北京电信记录
# 更新北京电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_BEIJING_CT2,
        "RecordType": record_type,
        "RecordLine": "北京电信",
        "Value": ip2_BEIJING_CT
    }
    req.from_json_string(json.dumps(params))
    resp_BEIJING_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_BEIJING_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 北京移动
# 获取北京移动 CDN 调度结果
...
# 考虑到 CDN 存在多级CNAME，故从第二个data开始取值，保险起见仅取两值
ip1_BEIJING_CM= result_BEIJING_CM['Answer'][1]['data']
ip2_BEIJING_CM= result_BEIJING_CM['Answer'][2]['data']
# 获取北京移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_BEIJING_CM2 = result_BEIJING_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新北京移动记录
# 更新北京移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_BEIJING_CM2,
        "RecordType": record_type,
        "RecordLine": "北京移动",
        "Value": ip2_BEIJING_CM
    }
    req.from_json_string(json.dumps(params))
    resp_BEIJING_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_BEIJING_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 天津
# 天津联通
...
# 考虑到 CDN 存在多级CNAME，故从第二个data开始取值，保险起见仅取两值
ip1_TIANJIN_CU= result_TIANJIN_CU['Answer'][1]['data']
ip2_TIANJIN_CU= result_TIANJIN_CU['Answer'][2]['data']
# 获取天津联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_TIANJIN_CU2 = result_TIANJIN_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新天津联通记录
# 更新天津联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_TIANJIN_CU2,
        "RecordType": record_type,
        "RecordLine": "天津联通",
        "Value": ip2_TIANJIN_CU
    }
    req.from_json_string(json.dumps(params))
    resp_TIANJIN_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_TIANJIN_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 天津电信
# 获取天津电信 CDN 调度结果
...
# 考虑到 CDN 存在多级CNAME，故从第二个data开始取值，保险起见仅取两值
ip1_TIANJIN_CT= result_TIANJIN_CT['Answer'][1]['data']
ip2_TIANJIN_CT= result_TIANJIN_CT['Answer'][2]['data']
# 获取天津电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_TIANJIN_CT2 = result_TIANJIN_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新天津电信记录
# 更新天津电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_TIANJIN_CT2,
        "RecordType": record_type,
        "RecordLine": "天津电信",
        "Value": ip2_TIANJIN_CT
    }
    req.from_json_string(json.dumps(params))
    resp_TIANJIN_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_TIANJIN_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 天津移动
# 获取天津移动 CDN 调度结果
...
# 考虑到 CDN 存在多级CNAME，故从第二个data开始取值，保险起见仅取两值
ip1_TIANJIN_CM= result_TIANJIN_CM['Answer'][1]['data']
ip2_TIANJIN_CM= result_TIANJIN_CM['Answer'][2]['data']
# 获取天津移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_TIANJIN_CM2 = result_TIANJIN_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新天津移动记录
# 更新天津移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_TIANJIN_CM2,
        "RecordType": record_type,
        "RecordLine": "天津移动",
        "Value": ip2_TIANJIN_CM
    }
    req.from_json_string(json.dumps(params))
    resp_TIANJIN_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_TIANJIN_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 河北
# 河北联通
...
# 解析返回结果
ip1_HEBEI_CU= result_HEBEI_CU['Answer'][1]['data']
ip2_HEBEI_CU= result_HEBEI_CU['Answer'][2]['data']
# 获取河北联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_HEBEI_CU2 = result_HEBEI_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新河北联通记录
# 更新河北联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_HEBEI_CU2,
        "RecordType": record_type,
        "RecordLine": "河北联通",
        "Value": ip2_HEBEI_CU
    }
    req.from_json_string(json.dumps(params))
    resp_HEBEI_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_HEBEI_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 河北电信
# 获取河北电信 CDN 调度结果
...
# 解析返回结果
ip1_HEBEI_CT= result_HEBEI_CT['Answer'][1]['data']
ip2_HEBEI_CT= result_HEBEI_CT['Answer'][2]['data']
# 获取河北电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_HEBEI_CT2 = result_HEBEI_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新河北电信记录
# 更新河北电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_HEBEI_CT2,
        "RecordType": record_type,
        "RecordLine": "河北电信",
        "Value": ip2_HEBEI_CT
    }
    req.from_json_string(json.dumps(params))
    resp_HEBEI_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_HEBEI_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 河北移动
# 获取河北移动 CDN 调度结果
...
# 解析返回结果
ip1_HEBEI_CM= result_HEBEI_CM['Answer'][1]['data']
ip2_HEBEI_CM= result_HEBEI_CM['Answer'][2]['data']
# 获取河北移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_HEBEI_CM2 = result_HEBEI_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新河北移动记录
# 更新河北移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_HEBEI_CM2,
        "RecordType": record_type,
        "RecordLine": "河北移动",
        "Value": ip2_HEBEI_CM
    }
    req.from_json_string(json.dumps(params))
    resp_HEBEI_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_HEBEI_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 山西
# 山西联通
...
# 解析返回结果
ip1_SHANXI_CU= result_SHANXI_CU['Answer'][1]['data']
ip2_SHANXI_CU= result_SHANXI_CU['Answer'][2]['data']
# 获取山西联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_SHANXI_CU2 = result_SHANXI_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新山西联通记录
# 更新山西联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_SHANXI_CU2,
        "RecordType": record_type,
        "RecordLine": "山西联通",
        "Value": ip2_SHANXI_CU
    }
    req.from_json_string(json.dumps(params))
    resp_SHANXI_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_SHANXI_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 山西电信
# 获取山西电信 CDN 调度结果
...
# 解析返回结果
ip1_SHANXI_CT= result_SHANXI_CT['Answer'][1]['data']
ip2_SHANXI_CT= result_SHANXI_CT['Answer'][2]['data']
# 获取山西电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_SHANXI_CT2 = result_SHANXI_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新山西电信记录
# 更新山西电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_SHANXI_CT2,
        "RecordType": record_type,
        "RecordLine": "山西电信",
        "Value": ip2_SHANXI_CT
    }
    req.from_json_string(json.dumps(params))
    resp_SHANXI_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_SHANXI_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 山西移动
# 获取山西移动 CDN 调度结果
...
# 解析返回结果
ip1_SHANXI_CM= result_SHANXI_CM['Answer'][1]['data']
ip2_SHANXI_CM= result_SHANXI_CM['Answer'][2]['data']
# 获取山西移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_SHANXI_CM2 = result_SHANXI_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新山西移动记录
# 更新山西移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_SHANXI_CM2,
        "RecordType": record_type,
        "RecordLine": "山西移动",
        "Value": ip2_SHANXI_CM
    }
    req.from_json_string(json.dumps(params))
    resp_SHANXI_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_SHANXI_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 内蒙
# 内蒙联通
...
# 解析返回结果
ip1_NEIMENGGU_CU= result_NEIMENGGU_CU['Answer'][1]['data']
ip2_NEIMENGGU_CU= result_NEIMENGGU_CU['Answer'][2]['data']
# 获取内蒙联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_NEIMENGGU_CU2 = result_NEIMENGGU_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新内蒙联通记录
# 更新内蒙联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_NEIMENGGU_CU2,
        "RecordType": record_type,
        "RecordLine": "内蒙联通",
        "Value": ip2_NEIMENGGU_CU
    }
    req.from_json_string(json.dumps(params))
    resp_NEIMENGGU_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_NEIMENGGU_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 内蒙电信
# 获取内蒙电信 CDN 调度结果
...
# 解析返回结果
ip1_NEIMENGGU_CT= result_NEIMENGGU_CT['Answer'][1]['data']
ip2_NEIMENGGU_CT= result_NEIMENGGU_CT['Answer'][2]['data']
# 获取内蒙电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_NEIMENGGU_CT2 = result_NEIMENGGU_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新内蒙电信记录
# 更新内蒙电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_NEIMENGGU_CT2,
        "RecordType": record_type,
        "RecordLine": "内蒙电信",
        "Value": ip2_NEIMENGGU_CT
    }
    req.from_json_string(json.dumps(params))
    resp_NEIMENGGU_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_NEIMENGGU_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 内蒙移动
# 获取内蒙移动 CDN 调度结果
...
# 解析返回结果
ip1_NEIMENGGU_CM= result_NEIMENGGU_CM['Answer'][1]['data']
ip2_NEIMENGGU_CM= result_NEIMENGGU_CM['Answer'][2]['data']
# 获取内蒙移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_NEIMENGGU_CM2 = result_NEIMENGGU_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新内蒙移动记录
# 更新内蒙移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_NEIMENGGU_CM2,
        "RecordType": record_type,
        "RecordLine": "内蒙移动",
        "Value": ip2_NEIMENGGU_CM
    }
    req.from_json_string(json.dumps(params))
    resp_NEIMENGGU_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_NEIMENGGU_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 广东
# 广东联通
...
# 解析返回结果
ip1_GUANGDONG_CU= result_GUANGDONG_CU['Answer'][1]['data']
ip2_GUANGDONG_CU= result_GUANGDONG_CU['Answer'][2]['data']
# 获取广东联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_GUANGDONG_CU2 = result_GUANGDONG_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新广东联通记录
# 更新广东联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_GUANGDONG_CU2,
        "RecordType": record_type,
        "RecordLine": "广东联通",
        "Value": ip2_GUANGDONG_CU
    }
    req.from_json_string(json.dumps(params))
    resp_GUANGDONG_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_GUANGDONG_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 广东电信
# 获取广东电信 CDN 调度结果
...
# 解析返回结果
ip1_GUANGDONG_CT= result_GUANGDONG_CT['Answer'][1]['data']
ip2_GUANGDONG_CT= result_GUANGDONG_CT['Answer'][2]['data']
# 获取广东电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_GUANGDONG_CT2 = result_GUANGDONG_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新广东电信记录
# 更新广东电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_GUANGDONG_CT2,
        "RecordType": record_type,
        "RecordLine": "广东电信",
        "Value": ip2_GUANGDONG_CT
    }
    req.from_json_string(json.dumps(params))
    resp_GUANGDONG_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_GUANGDONG_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 广东移动
# 获取广东移动 CDN 调度结果
...
# 解析返回结果
ip1_GUANGDONG_CM= result_GUANGDONG_CM['Answer'][1]['data']
ip2_GUANGDONG_CM= result_GUANGDONG_CM['Answer'][2]['data']
# 获取广东移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_GUANGDONG_CM2 = result_GUANGDONG_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新广东移动记录
# 更新广东移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_GUANGDONG_CM2,
        "RecordType": record_type,
        "RecordLine": "广东移动",
        "Value": ip2_GUANGDONG_CM
    }
    req.from_json_string(json.dumps(params))
    resp_GUANGDONG_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_GUANGDONG_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 广西
# 广西联通
...
# 解析返回结果
ip1_GUANGXI_CU= result_GUANGXI_CU['Answer'][1]['data']
ip2_GUANGXI_CU= result_GUANGXI_CU['Answer'][2]['data']
# 获取广西联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_GUANGXI_CU2 = result_GUANGXI_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新广西联通记录
# 更新广西联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_GUANGXI_CU2,
        "RecordType": record_type,
        "RecordLine": "广西联通",
        "Value": ip2_GUANGXI_CU
    }
    req.from_json_string(json.dumps(params))
    resp_GUANGXI_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_GUANGXI_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 广西电信
# 获取广西电信 CDN 调度结果
...
# 解析返回结果
ip1_GUANGXI_CT= result_GUANGXI_CT['Answer'][1]['data']
ip2_GUANGXI_CT= result_GUANGXI_CT['Answer'][2]['data']
# 获取广西电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_GUANGXI_CT2 = result_GUANGXI_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新广西电信记录
# 更新广西电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_GUANGXI_CT2,
        "RecordType": record_type,
        "RecordLine": "广西电信",
        "Value": ip2_GUANGXI_CT
    }
    req.from_json_string(json.dumps(params))
    resp_GUANGXI_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_GUANGXI_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 广西移动
# 获取广西移动 CDN 调度结果
...
# 解析返回结果
ip1_GUANGXI_CM= result_GUANGXI_CM['Answer'][1]['data']
ip2_GUANGXI_CM= result_GUANGXI_CM['Answer'][2]['data']
# 获取广西移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_GUANGXI_CM2 = result_GUANGXI_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新广西移动记录
# 更新广西移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_GUANGXI_CM2,
        "RecordType": record_type,
        "RecordLine": "广西移动",
        "Value": ip2_GUANGXI_CM
    }
    req.from_json_string(json.dumps(params))
    resp_GUANGXI_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_GUANGXI_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 海南
# 海南联通
...
# 解析返回结果
ip1_HAINAN_CU= result_HAINAN_CU['Answer'][1]['data']
ip2_HAINAN_CU= result_HAINAN_CU['Answer'][2]['data']
# 获取海南联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_HAINAN_CU2 = result_HAINAN_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新海南联通记录
# 更新海南联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_HAINAN_CU2,
        "RecordType": record_type,
        "RecordLine": "海南联通",
        "Value": ip2_HAINAN_CU
    }
    req.from_json_string(json.dumps(params))
    resp_HAINAN_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_HAINAN_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 海南电信
# 获取海南电信 CDN 调度结果
...
# 解析返回结果
ip1_HAINAN_CT= result_HAINAN_CT['Answer'][1]['data']
ip2_HAINAN_CT= result_HAINAN_CT['Answer'][2]['data']
# 获取海南电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_HAINAN_CT2 = result_HAINAN_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新海南电信记录
# 更新海南电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_HAINAN_CT2,
        "RecordType": record_type,
        "RecordLine": "海南电信",
        "Value": ip2_HAINAN_CT
    }
    req.from_json_string(json.dumps(params))
    resp_HAINAN_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_HAINAN_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 海南移动
# 获取海南移动 CDN 调度结果
...
# 解析返回结果
ip1_HAINAN_CM= result_HAINAN_CM['Answer'][1]['data']
ip2_HAINAN_CM= result_HAINAN_CM['Answer'][2]['data']
# 获取海南移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_HAINAN_CM2 = result_HAINAN_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新海南移动记录
# 更新海南移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_HAINAN_CM2,
        "RecordType": record_type,
        "RecordLine": "海南移动",
        "Value": ip2_HAINAN_CM
    }
    req.from_json_string(json.dumps(params))
    resp_HAINAN_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_HAINAN_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 福建
# 福建联通
...
# 解析返回结果
ip1_FUJIAN_CU= result_FUJIAN_CU['Answer'][1]['data']
ip2_FUJIAN_CU= result_FUJIAN_CU['Answer'][2]['data']
# 获取福建联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_FUJIAN_CU2 = result_FUJIAN_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新福建联通记录
# 更新福建联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_FUJIAN_CU2,
        "RecordType": record_type,
        "RecordLine": "福建联通",
        "Value": ip2_FUJIAN_CU
    }
    req.from_json_string(json.dumps(params))
    resp_FUJIAN_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_FUJIAN_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 福建电信
# 获取福建电信 CDN 调度结果
...
# 解析返回结果
ip1_FUJIAN_CT= result_FUJIAN_CT['Answer'][1]['data']
ip2_FUJIAN_CT= result_FUJIAN_CT['Answer'][2]['data']
# 获取福建电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_FUJIAN_CT2 = result_FUJIAN_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新福建电信记录
# 更新福建电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_FUJIAN_CT2,
        "RecordType": record_type,
        "RecordLine": "福建电信",
        "Value": ip2_FUJIAN_CT
    }
    req.from_json_string(json.dumps(params))
    resp_FUJIAN_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_FUJIAN_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 福建移动
# 获取福建移动 CDN 调度结果
...
# 解析返回结果
ip1_FUJIAN_CM= result_FUJIAN_CM['Answer'][1]['data']
ip2_FUJIAN_CM= result_FUJIAN_CM['Answer'][2]['data']
# 获取福建移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_FUJIAN_CM2 = result_FUJIAN_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新福建移动记录
# 更新福建移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_FUJIAN_CM2,
        "RecordType": record_type,
        "RecordLine": "福建移动",
        "Value": ip2_FUJIAN_CM
    }
    req.from_json_string(json.dumps(params))
    resp_FUJIAN_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_FUJIAN_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 上海
# 上海联通
...
# 解析返回结果
ip1_SHANGHAI_CU= result_SHANGHAI_CU['Answer'][1]['data']
ip2_SHANGHAI_CU= result_SHANGHAI_CU['Answer'][2]['data']
# 获取上海联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_SHANGHAI_CU2 = result_SHANGHAI_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新上海联通记录
# 更新上海联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_SHANGHAI_CU2,
        "RecordType": record_type,
        "RecordLine": "上海联通",
        "Value": ip2_SHANGHAI_CU
    }
    req.from_json_string(json.dumps(params))
    resp_SHANGHAI_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_SHANGHAI_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 上海电信
# 获取上海电信 CDN 调度结果
...
# 解析返回结果
ip1_SHANGHAI_CT= result_SHANGHAI_CT['Answer'][1]['data']
ip2_SHANGHAI_CT= result_SHANGHAI_CT['Answer'][2]['data']
# 获取上海电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_SHANGHAI_CT2 = result_SHANGHAI_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新上海电信记录
# 更新上海电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_SHANGHAI_CT2,
        "RecordType": record_type,
        "RecordLine": "上海电信",
        "Value": ip2_SHANGHAI_CT
    }
    req.from_json_string(json.dumps(params))
    resp_SHANGHAI_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_SHANGHAI_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 上海移动
# 获取上海移动 CDN 调度结果
...
# 解析返回结果
ip1_SHANGHAI_CM= result_SHANGHAI_CM['Answer'][1]['data']
ip2_SHANGHAI_CM= result_SHANGHAI_CM['Answer'][2]['data']
# 获取上海移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_SHANGHAI_CM2 = result_SHANGHAI_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新上海移动记录
# 更新上海移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_SHANGHAI_CM2,
        "RecordType": record_type,
        "RecordLine": "上海移动",
        "Value": ip2_SHANGHAI_CM
    }
    req.from_json_string(json.dumps(params))
    resp_SHANGHAI_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_SHANGHAI_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 江苏
# 江苏联通
...
# 解析返回结果
ip1_JIANGSU_CU= result_JIANGSU_CU['Answer'][1]['data']
ip2_JIANGSU_CU= result_JIANGSU_CU['Answer'][2]['data']
# 获取江苏联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_JIANGSU_CU2 = result_JIANGSU_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新江苏联通记录
# 更新江苏联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_JIANGSU_CU2,
        "RecordType": record_type,
        "RecordLine": "江苏联通",
        "Value": ip2_JIANGSU_CU
    }
    req.from_json_string(json.dumps(params))
    resp_JIANGSU_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_JIANGSU_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 江苏电信
# 获取江苏电信 CDN 调度结果
...
# 解析返回结果
ip1_JIANGSU_CT= result_JIANGSU_CT['Answer'][1]['data']
ip2_JIANGSU_CT= result_JIANGSU_CT['Answer'][2]['data']
# 获取江苏电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_JIANGSU_CT2 = result_JIANGSU_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新江苏电信记录
# 更新江苏电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_JIANGSU_CT2,
        "RecordType": record_type,
        "RecordLine": "江苏电信",
        "Value": ip2_JIANGSU_CT
    }
    req.from_json_string(json.dumps(params))
    resp_JIANGSU_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_JIANGSU_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 江苏移动
# 获取江苏移动 CDN 调度结果
...
# 解析返回结果
ip1_JIANGSU_CM= result_JIANGSU_CM['Answer'][1]['data']
ip2_JIANGSU_CM= result_JIANGSU_CM['Answer'][2]['data']
# 获取江苏移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_JIANGSU_CM2 = result_JIANGSU_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新江苏移动记录
# 更新江苏移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_JIANGSU_CM2,
        "RecordType": record_type,
        "RecordLine": "江苏移动",
        "Value": ip2_JIANGSU_CM
    }
    req.from_json_string(json.dumps(params))
    resp_JIANGSU_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_JIANGSU_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 浙江
# 浙江联通
...
# 解析返回结果
ip1_ZHEJIANG_CU= result_ZHEJIANG_CU['Answer'][1]['data']
ip2_ZHEJIANG_CU= result_ZHEJIANG_CU['Answer'][2]['data']
# 获取浙江联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_ZHEJIANG_CU2 = result_ZHEJIANG_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新浙江联通记录
# 更新浙江联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_ZHEJIANG_CU2,
        "RecordType": record_type,
        "RecordLine": "浙江联通",
        "Value": ip2_ZHEJIANG_CU
    }
    req.from_json_string(json.dumps(params))
    resp_ZHEJIANG_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_ZHEJIANG_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 浙江电信
# 获取浙江电信 CDN 调度结果
...
# 解析返回结果
ip1_ZHEJIANG_CT= result_ZHEJIANG_CT['Answer'][1]['data']
ip2_ZHEJIANG_CT= result_ZHEJIANG_CT['Answer'][2]['data']
# 获取浙江电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_ZHEJIANG_CT2 = result_ZHEJIANG_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新浙江电信记录
# 更新浙江电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_ZHEJIANG_CT2,
        "RecordType": record_type,
        "RecordLine": "浙江电信",
        "Value": ip2_ZHEJIANG_CT
    }
    req.from_json_string(json.dumps(params))
    resp_ZHEJIANG_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_ZHEJIANG_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 浙江移动
# 获取浙江移动 CDN 调度结果
...
# 解析返回结果
ip1_ZHEJIANG_CM= result_ZHEJIANG_CM['Answer'][1]['data']
ip2_ZHEJIANG_CM= result_ZHEJIANG_CM['Answer'][2]['data']
# 获取浙江移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_ZHEJIANG_CM2 = result_ZHEJIANG_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新浙江移动记录
# 更新浙江移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_ZHEJIANG_CM2,
        "RecordType": record_type,
        "RecordLine": "浙江移动",
        "Value": ip2_ZHEJIANG_CM
    }
    req.from_json_string(json.dumps(params))
    resp_ZHEJIANG_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_ZHEJIANG_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 山东
# 山东联通
...
# 解析返回结果
ip1_SHANDONG_CU= result_SHANDONG_CU['Answer'][1]['data']
ip2_SHANDONG_CU= result_SHANDONG_CU['Answer'][2]['data']
# 获取山东联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_SHANDONG_CU2 = result_SHANDONG_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新山东联通记录
# 更新山东联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_SHANDONG_CU2,
        "RecordType": record_type,
        "RecordLine": "山东联通",
        "Value": ip2_SHANDONG_CU
    }
    req.from_json_string(json.dumps(params))
    resp_SHANDONG_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_SHANDONG_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 山东电信
# 获取山东电信 CDN 调度结果
...
# 解析返回结果
ip1_SHANDONG_CT= result_SHANDONG_CT['Answer'][1]['data']
ip2_SHANDONG_CT= result_SHANDONG_CT['Answer'][2]['data']
# 获取山东电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_SHANDONG_CT2 = result_SHANDONG_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新山东电信记录
# 更新山东电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_SHANDONG_CT2,
        "RecordType": record_type,
        "RecordLine": "山东电信",
        "Value": ip2_SHANDONG_CT
    }
    req.from_json_string(json.dumps(params))
    resp_SHANDONG_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_SHANDONG_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 山东移动
# 获取山东移动 CDN 调度结果
...
# 解析返回结果
ip1_SHANDONG_CM= result_SHANDONG_CM['Answer'][1]['data']
ip2_SHANDONG_CM= result_SHANDONG_CM['Answer'][2]['data']
# 获取山东移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_SHANDONG_CM2 = result_SHANDONG_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新山东移动记录
# 更新山东移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_SHANDONG_CM2,
        "RecordType": record_type,
        "RecordLine": "山东移动",
        "Value": ip2_SHANDONG_CM
    }
    req.from_json_string(json.dumps(params))
    resp_SHANDONG_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_SHANDONG_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 安徽
# 安徽联通
...
# 解析返回结果
ip1_ANHUI_CU= result_ANHUI_CU['Answer'][1]['data']
ip2_ANHUI_CU= result_ANHUI_CU['Answer'][2]['data']
# 获取安徽联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_ANHUI_CU2 = result_ANHUI_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新安徽联通记录
# 更新安徽联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_ANHUI_CU2,
        "RecordType": record_type,
        "RecordLine": "安徽联通",
        "Value": ip2_ANHUI_CU
    }
    req.from_json_string(json.dumps(params))
    resp_ANHUI_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_ANHUI_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 安徽电信
# 获取安徽电信 CDN 调度结果
...
# 解析返回结果
ip1_ANHUI_CT= result_ANHUI_CT['Answer'][1]['data']
ip2_ANHUI_CT= result_ANHUI_CT['Answer'][2]['data']
# 获取安徽电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_ANHUI_CT2 = result_ANHUI_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新安徽电信记录
# 更新安徽电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_ANHUI_CT2,
        "RecordType": record_type,
        "RecordLine": "安徽电信",
        "Value": ip2_ANHUI_CT
    }
    req.from_json_string(json.dumps(params))
    resp_ANHUI_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_ANHUI_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 安徽移动
# 获取安徽移动 CDN 调度结果
...
# 解析返回结果
ip1_ANHUI_CM= result_ANHUI_CM['Answer'][1]['data']
ip2_ANHUI_CM= result_ANHUI_CM['Answer'][2]['data']
# 获取安徽移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_ANHUI_CM2 = result_ANHUI_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新安徽移动记录
# 更新安徽移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_ANHUI_CM2,
        "RecordType": record_type,
        "RecordLine": "安徽移动",
        "Value": ip2_ANHUI_CM
    }
    req.from_json_string(json.dumps(params))
    resp_ANHUI_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_ANHUI_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 湖北
# 湖北联通
...
# 解析返回结果
ip1_HUBEI_CU= result_HUBEI_CU['Answer'][1]['data']
ip2_HUBEI_CU= result_HUBEI_CU['Answer'][2]['data']
# 获取湖北联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_HUBEI_CU2 = result_HUBEI_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新湖北联通记录
# 更新湖北联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_HUBEI_CU2,
        "RecordType": record_type,
        "RecordLine": "湖北联通",
        "Value": ip2_HUBEI_CU
    }
    req.from_json_string(json.dumps(params))
    resp_HUBEI_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_HUBEI_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 湖北电信
# 获取湖北电信 CDN 调度结果
...
# 解析返回结果
ip1_HUBEI_CT= result_HUBEI_CT['Answer'][1]['data']
ip2_HUBEI_CT= result_HUBEI_CT['Answer'][2]['data']
# 获取湖北电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_HUBEI_CT2 = result_HUBEI_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新湖北电信记录
# 更新湖北电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_HUBEI_CT2,
        "RecordType": record_type,
        "RecordLine": "湖北电信",
        "Value": ip2_HUBEI_CT
    }
    req.from_json_string(json.dumps(params))
    resp_HUBEI_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_HUBEI_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 湖北移动
# 获取湖北移动 CDN 调度结果
...
# 解析返回结果
ip1_HUBEI_CM= result_HUBEI_CM['Answer'][1]['data']
ip2_HUBEI_CM= result_HUBEI_CM['Answer'][2]['data']
# 获取湖北移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_HUBEI_CM2 = result_HUBEI_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新湖北移动记录
# 更新湖北移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_HUBEI_CM2,
        "RecordType": record_type,
        "RecordLine": "湖北移动",
        "Value": ip2_HUBEI_CM
    }
    req.from_json_string(json.dumps(params))
    resp_HUBEI_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_HUBEI_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 湖南
# 湖南联通
...
# 解析返回结果
ip1_HUNAN_CU= result_HUNAN_CU['Answer'][1]['data']
ip2_HUNAN_CU= result_HUNAN_CU['Answer'][2]['data']
# 获取湖南联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_HUNAN_CU2 = result_HUNAN_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新湖南联通记录
# 更新湖南联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_HUNAN_CU2,
        "RecordType": record_type,
        "RecordLine": "湖南联通",
        "Value": ip2_HUNAN_CU
    }
    req.from_json_string(json.dumps(params))
    resp_HUNAN_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_HUNAN_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 湖南电信
# 获取湖南电信 CDN 调度结果
...
# 解析返回结果
ip1_HUNAN_CT= result_HUNAN_CT['Answer'][1]['data']
ip2_HUNAN_CT= result_HUNAN_CT['Answer'][2]['data']
# 获取湖南电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_HUNAN_CT2 = result_HUNAN_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新湖南电信记录
# 更新湖南电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_HUNAN_CT2,
        "RecordType": record_type,
        "RecordLine": "湖南电信",
        "Value": ip2_HUNAN_CT
    }
    req.from_json_string(json.dumps(params))
    resp_HUNAN_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_HUNAN_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 湖南移动
# 获取湖南移动 CDN 调度结果
...
# 解析返回结果
ip1_HUNAN_CM= result_HUNAN_CM['Answer'][1]['data']
ip2_HUNAN_CM= result_HUNAN_CM['Answer'][2]['data']
# 获取湖南移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_HUNAN_CM2 = result_HUNAN_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新湖南移动记录
# 更新湖南移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_HUNAN_CM2,
        "RecordType": record_type,
        "RecordLine": "湖南移动",
        "Value": ip2_HUNAN_CM
    }
    req.from_json_string(json.dumps(params))
    resp_HUNAN_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_HUNAN_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 河南
# 河南联通
...
# 解析返回结果
ip1_HENAN_CU= result_HENAN_CU['Answer'][1]['data']
ip2_HENAN_CU= result_HENAN_CU['Answer'][2]['data']
# 获取河南联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_HENAN_CU2 = result_HENAN_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新河南联通记录
# 更新河南联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_HENAN_CU2,
        "RecordType": record_type,
        "RecordLine": "河南联通",
        "Value": ip2_HENAN_CU
    }
    req.from_json_string(json.dumps(params))
    resp_HENAN_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_HENAN_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 河南电信
# 获取河南电信 CDN 调度结果
...
# 解析返回结果
ip1_HENAN_CT= result_HENAN_CT['Answer'][1]['data']
ip2_HENAN_CT= result_HENAN_CT['Answer'][2]['data']
# 获取河南电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_HENAN_CT2 = result_HENAN_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新河南电信记录
# 更新河南电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_HENAN_CT2,
        "RecordType": record_type,
        "RecordLine": "河南电信",
        "Value": ip2_HENAN_CT
    }
    req.from_json_string(json.dumps(params))
    resp_HENAN_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_HENAN_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 河南移动
# 获取河南移动 CDN 调度结果
...
# 解析返回结果
ip1_HENAN_CM= result_HENAN_CM['Answer'][1]['data']
ip2_HENAN_CM= result_HENAN_CM['Answer'][2]['data']
# 获取河南移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_HENAN_CM2 = result_HENAN_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新河南移动记录
# 更新河南移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_HENAN_CM2,
        "RecordType": record_type,
        "RecordLine": "河南移动",
        "Value": ip2_HENAN_CM
    }
    req.from_json_string(json.dumps(params))
    resp_HENAN_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_HENAN_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 江西
# 江西联通
...
# 解析返回结果
ip1_JIANGXI_CU= result_JIANGXI_CU['Answer'][1]['data']
ip2_JIANGXI_CU= result_JIANGXI_CU['Answer'][2]['data']
# 获取江西联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_JIANGXI_CU2 = result_JIANGXI_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新江西联通记录
# 更新江西联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_JIANGXI_CU2,
        "RecordType": record_type,
        "RecordLine": "江西联通",
        "Value": ip2_JIANGXI_CU
    }
    req.from_json_string(json.dumps(params))
    resp_JIANGXI_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_JIANGXI_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 江西电信
# 获取江西电信 CDN 调度结果
...
# 解析返回结果
ip1_JIANGXI_CT= result_JIANGXI_CT['Answer'][1]['data']
ip2_JIANGXI_CT= result_JIANGXI_CT['Answer'][2]['data']
# 获取江西电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_JIANGXI_CT2 = result_JIANGXI_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新江西电信记录
# 更新江西电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_JIANGXI_CT2,
        "RecordType": record_type,
        "RecordLine": "江西电信",
        "Value": ip2_JIANGXI_CT
    }
    req.from_json_string(json.dumps(params))
    resp_JIANGXI_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_JIANGXI_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 江西移动
# 获取江西移动 CDN 调度结果
...
# 解析返回结果
ip1_JIANGXI_CM= result_JIANGXI_CM['Answer'][1]['data']
ip2_JIANGXI_CM= result_JIANGXI_CM['Answer'][2]['data']
# 获取江西移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_JIANGXI_CM2 = result_JIANGXI_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新江西移动记录
# 更新江西移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_JIANGXI_CM2,
        "RecordType": record_type,
        "RecordLine": "江西移动",
        "Value": ip2_JIANGXI_CM
    }
    req.from_json_string(json.dumps(params))
    resp_JIANGXI_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_JIANGXI_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 四川
# 四川联通
...
# 解析返回结果
ip1_SICHUAN_CU= result_SICHUAN_CU['Answer'][1]['data']
ip2_SICHUAN_CU= result_SICHUAN_CU['Answer'][2]['data']
# 获取四川联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_SICHUAN_CU2 = result_SICHUAN_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新四川联通记录
# 更新四川联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_SICHUAN_CU2,
        "RecordType": record_type,
        "RecordLine": "四川联通",
        "Value": ip2_SICHUAN_CU
    }
    req.from_json_string(json.dumps(params))
    resp_SICHUAN_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_SICHUAN_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 四川电信
# 获取四川电信 CDN 调度结果
...
# 解析返回结果
ip1_SICHUAN_CT= result_SICHUAN_CT['Answer'][1]['data']
ip2_SICHUAN_CT= result_SICHUAN_CT['Answer'][2]['data']
# 获取四川电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_SICHUAN_CT2 = result_SICHUAN_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新四川电信记录
# 更新四川电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_SICHUAN_CT2,
        "RecordType": record_type,
        "RecordLine": "四川电信",
        "Value": ip2_SICHUAN_CT
    }
    req.from_json_string(json.dumps(params))
    resp_SICHUAN_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_SICHUAN_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 四川移动
# 获取四川移动 CDN 调度结果
...
# 解析返回结果
ip1_SICHUAN_CM= result_SICHUAN_CM['Answer'][1]['data']
ip2_SICHUAN_CM= result_SICHUAN_CM['Answer'][2]['data']
# 获取四川移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_SICHUAN_CM2 = result_SICHUAN_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新四川移动记录
# 更新四川移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_SICHUAN_CM2,
        "RecordType": record_type,
        "RecordLine": "四川移动",
        "Value": ip2_SICHUAN_CM
    }
    req.from_json_string(json.dumps(params))
    resp_SICHUAN_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_SICHUAN_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 重庆
# 重庆联通
...
# 解析返回结果
ip1_CHONGQING_CU= result_CHONGQING_CU['Answer'][1]['data']
ip2_CHONGQING_CU= result_CHONGQING_CU['Answer'][2]['data']
# 获取重庆联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_CHONGQING_CU2 = result_CHONGQING_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新重庆联通记录
# 更新重庆联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_CHONGQING_CU2,
        "RecordType": record_type,
        "RecordLine": "重庆联通",
        "Value": ip2_CHONGQING_CU
    }
    req.from_json_string(json.dumps(params))
    resp_CHONGQING_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_CHONGQING_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 重庆电信
# 获取重庆电信 CDN 调度结果
...
# 解析返回结果
ip1_CHONGQING_CT= result_CHONGQING_CT['Answer'][1]['data']
ip2_CHONGQING_CT= result_CHONGQING_CT['Answer'][2]['data']
# 获取重庆电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_CHONGQING_CT2 = result_CHONGQING_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新重庆电信记录
# 更新重庆电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_CHONGQING_CT2,
        "RecordType": record_type,
        "RecordLine": "重庆电信",
        "Value": ip2_CHONGQING_CT
    }
    req.from_json_string(json.dumps(params))
    resp_CHONGQING_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_CHONGQING_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 重庆移动
# 获取重庆移动 CDN 调度结果
...
# 解析返回结果
ip1_CHONGQING_CM= result_CHONGQING_CM['Answer'][1]['data']
ip2_CHONGQING_CM= result_CHONGQING_CM['Answer'][2]['data']
# 获取重庆移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_CHONGQING_CM2 = result_CHONGQING_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新重庆移动记录
# 更新重庆移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_CHONGQING_CM2,
        "RecordType": record_type,
        "RecordLine": "重庆移动",
        "Value": ip2_CHONGQING_CM
    }
    req.from_json_string(json.dumps(params))
    resp_CHONGQING_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_CHONGQING_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 贵州
# 贵州联通
...
# 解析返回结果
ip1_GUIZHOU_CU= result_GUIZHOU_CU['Answer'][1]['data']
ip2_GUIZHOU_CU= result_GUIZHOU_CU['Answer'][2]['data']
# 获取贵州联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_GUIZHOU_CU2 = result_GUIZHOU_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新贵州联通记录
# 更新贵州联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_GUIZHOU_CU2,
        "RecordType": record_type,
        "RecordLine": "贵州联通",
        "Value": ip2_GUIZHOU_CU
    }
    req.from_json_string(json.dumps(params))
    resp_GUIZHOU_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_GUIZHOU_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 贵州电信
# 获取贵州电信 CDN 调度结果
...
# 解析返回结果
ip1_GUIZHOU_CT= result_GUIZHOU_CT['Answer'][1]['data']
ip2_GUIZHOU_CT= result_GUIZHOU_CT['Answer'][2]['data']
# 获取贵州电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_GUIZHOU_CT2 = result_GUIZHOU_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新贵州电信记录
# 更新贵州电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_GUIZHOU_CT2,
        "RecordType": record_type,
        "RecordLine": "贵州电信",
        "Value": ip2_GUIZHOU_CT
    }
    req.from_json_string(json.dumps(params))
    resp_GUIZHOU_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_GUIZHOU_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 贵州移动
# 获取贵州移动 CDN 调度结果
...
# 解析返回结果
ip1_GUIZHOU_CM= result_GUIZHOU_CM['Answer'][1]['data']
ip2_GUIZHOU_CM= result_GUIZHOU_CM['Answer'][2]['data']
# 获取贵州移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_GUIZHOU_CM2 = result_GUIZHOU_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新贵州移动记录
# 更新贵州移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_GUIZHOU_CM2,
        "RecordType": record_type,
        "RecordLine": "贵州移动",
        "Value": ip2_GUIZHOU_CM
    }
    req.from_json_string(json.dumps(params))
    resp_GUIZHOU_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_GUIZHOU_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 云南
# 云南联通
...
# 解析返回结果
ip1_YUNNAN_CU= result_YUNNAN_CU['Answer'][1]['data']
ip2_YUNNAN_CU= result_YUNNAN_CU['Answer'][2]['data']
# 获取云南联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_YUNNAN_CU2 = result_YUNNAN_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新云南联通记录
# 更新云南联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_YUNNAN_CU2,
        "RecordType": record_type,
        "RecordLine": "云南联通",
        "Value": ip2_YUNNAN_CU
    }
    req.from_json_string(json.dumps(params))
    resp_YUNNAN_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_YUNNAN_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 云南电信
# 获取云南电信 CDN 调度结果
...
# 解析返回结果
ip1_YUNNAN_CT= result_YUNNAN_CT['Answer'][1]['data']
ip2_YUNNAN_CT= result_YUNNAN_CT['Answer'][2]['data']
# 获取云南电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_YUNNAN_CT2 = result_YUNNAN_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新云南电信记录
# 更新云南电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_YUNNAN_CT2,
        "RecordType": record_type,
        "RecordLine": "云南电信",
        "Value": ip2_YUNNAN_CT
    }
    req.from_json_string(json.dumps(params))
    resp_YUNNAN_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_YUNNAN_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 云南移动
# 获取云南移动 CDN 调度结果
...
# 解析返回结果
ip1_YUNNAN_CM= result_YUNNAN_CM['Answer'][1]['data']
ip2_YUNNAN_CM= result_YUNNAN_CM['Answer'][2]['data']
# 获取云南移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_YUNNAN_CM2 = result_YUNNAN_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新云南移动记录
# 更新云南移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_YUNNAN_CM2,
        "RecordType": record_type,
        "RecordLine": "云南移动",
        "Value": ip2_YUNNAN_CM
    }
    req.from_json_string(json.dumps(params))
    resp_YUNNAN_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_YUNNAN_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 西藏
# 西藏联通
...
# 解析返回结果
ip1_XIZANG_CU= result_XIZANG_CU['Answer'][1]['data']
ip2_XIZANG_CU= result_XIZANG_CU['Answer'][2]['data']
# 获取西藏联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_XIZANG_CU2 = result_XIZANG_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新西藏联通记录
# 更新西藏联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_XIZANG_CU2,
        "RecordType": record_type,
        "RecordLine": "西藏联通",
        "Value": ip2_XIZANG_CU
    }
    req.from_json_string(json.dumps(params))
    resp_XIZANG_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_XIZANG_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 西藏电信
# 获取西藏电信 CDN 调度结果
...
# 解析返回结果
ip1_XIZANG_CT= result_XIZANG_CT['Answer'][1]['data']
ip2_XIZANG_CT= result_XIZANG_CT['Answer'][2]['data']
# 获取西藏电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_XIZANG_CT2 = result_XIZANG_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新西藏电信记录
# 更新西藏电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_XIZANG_CT2,
        "RecordType": record_type,
        "RecordLine": "西藏电信",
        "Value": ip2_XIZANG_CT
    }
    req.from_json_string(json.dumps(params))
    resp_XIZANG_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_XIZANG_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 西藏移动
# 获取西藏移动 CDN 调度结果
...
# 解析返回结果
ip1_XIZANG_CM= result_XIZANG_CM['Answer'][1]['data']
ip2_XIZANG_CM= result_XIZANG_CM['Answer'][2]['data']
# 获取西藏移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_XIZANG_CM2 = result_XIZANG_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新西藏移动记录
# 更新西藏移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_XIZANG_CM2,
        "RecordType": record_type,
        "RecordLine": "西藏移动",
        "Value": ip2_XIZANG_CM
    }
    req.from_json_string(json.dumps(params))
    resp_XIZANG_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_XIZANG_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 陕西
# 陕西联通
...
# 解析返回结果
ip1_SHAANXI_CU= result_SHAANXI_CU['Answer'][1]['data']
ip2_SHAANXI_CU= result_SHAANXI_CU['Answer'][2]['data']
# 获取陕西联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_SHAANXI_CU2 = result_SHAANXI_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新陕西联通记录
# 更新陕西联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_SHAANXI_CU2,
        "RecordType": record_type,
        "RecordLine": "陕西联通",
        "Value": ip2_SHAANXI_CU
    }
    req.from_json_string(json.dumps(params))
    resp_SHAANXI_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_SHAANXI_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 陕西电信
# 获取陕西电信 CDN 调度结果
...
# 解析返回结果
ip1_SHAANXI_CT= result_SHAANXI_CT['Answer'][1]['data']
ip2_SHAANXI_CT= result_SHAANXI_CT['Answer'][2]['data']
# 获取陕西电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_SHAANXI_CT2 = result_SHAANXI_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新陕西电信记录
# 更新陕西电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_SHAANXI_CT2,
        "RecordType": record_type,
        "RecordLine": "陕西电信",
        "Value": ip2_SHAANXI_CT
    }
    req.from_json_string(json.dumps(params))
    resp_SHAANXI_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_SHAANXI_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 陕西移动
# 获取陕西移动 CDN 调度结果
...
# 解析返回结果
ip1_SHAANXI_CM= result_SHAANXI_CM['Answer'][1]['data']
ip2_SHAANXI_CM= result_SHAANXI_CM['Answer'][2]['data']
# 获取陕西移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_SHAANXI_CM2 = result_SHAANXI_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新陕西移动记录
# 更新陕西移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_SHAANXI_CM2,
        "RecordType": record_type,
        "RecordLine": "陕西移动",
        "Value": ip2_SHAANXI_CM
    }
    req.from_json_string(json.dumps(params))
    resp_SHAANXI_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_SHAANXI_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 甘肃
# 甘肃联通
...
# 解析返回结果
ip1_GANSU_CU= result_GANSU_CU['Answer'][1]['data']
ip2_GANSU_CU= result_GANSU_CU['Answer'][2]['data']
# 获取甘肃联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_GANSU_CU2 = result_GANSU_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新甘肃联通记录
# 更新甘肃联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_GANSU_CU2,
        "RecordType": record_type,
        "RecordLine": "甘肃联通",
        "Value": ip2_GANSU_CU
    }
    req.from_json_string(json.dumps(params))
    resp_GANSU_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_GANSU_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 甘肃电信
# 获取甘肃电信 CDN 调度结果
...
# 解析返回结果
ip1_GANSU_CT= result_GANSU_CT['Answer'][1]['data']
ip2_GANSU_CT= result_GANSU_CT['Answer'][2]['data']
# 获取甘肃电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_GANSU_CT2 = result_GANSU_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新甘肃电信记录
# 更新甘肃电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_GANSU_CT2,
        "RecordType": record_type,
        "RecordLine": "甘肃电信",
        "Value": ip2_GANSU_CT
    }
    req.from_json_string(json.dumps(params))
    resp_GANSU_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_GANSU_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 甘肃移动
# 获取甘肃移动 CDN 调度结果
...
# 解析返回结果
ip1_GANSU_CM= result_GANSU_CM['Answer'][1]['data']
ip2_GANSU_CM= result_GANSU_CM['Answer'][2]['data']
# 获取甘肃移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_GANSU_CM2 = result_GANSU_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新甘肃移动记录
# 更新甘肃移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_GANSU_CM2,
        "RecordType": record_type,
        "RecordLine": "甘肃移动",
        "Value": ip2_GANSU_CM
    }
    req.from_json_string(json.dumps(params))
    resp_GANSU_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_GANSU_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 新疆
# 新疆联通
...
# 解析返回结果
ip1_XINJIANG_CU= result_XINJIANG_CU['Answer'][1]['data']
ip2_XINJIANG_CU= result_XINJIANG_CU['Answer'][2]['data']
# 获取新疆联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_XINJIANG_CU2 = result_XINJIANG_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新新疆联通记录
# 更新新疆联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_XINJIANG_CU2,
        "RecordType": record_type,
        "RecordLine": "新疆联通",
        "Value": ip2_XINJIANG_CU
    }
    req.from_json_string(json.dumps(params))
    resp_XINJIANG_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_XINJIANG_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 新疆电信
# 获取新疆电信 CDN 调度结果
...
# 解析返回结果
ip1_XINJIANG_CT= result_XINJIANG_CT['Answer'][1]['data']
ip2_XINJIANG_CT= result_XINJIANG_CT['Answer'][2]['data']
# 获取新疆电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_XINJIANG_CT2 = result_XINJIANG_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新新疆电信记录
# 更新新疆电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_XINJIANG_CT2,
        "RecordType": record_type,
        "RecordLine": "新疆电信",
        "Value": ip2_XINJIANG_CT
    }
    req.from_json_string(json.dumps(params))
    resp_XINJIANG_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_XINJIANG_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 新疆移动
# 获取新疆移动 CDN 调度结果
...
# 解析返回结果
ip1_XINJIANG_CM= result_XINJIANG_CM['Answer'][1]['data']
ip2_XINJIANG_CM= result_XINJIANG_CM['Answer'][2]['data']
# 获取新疆移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_XINJIANG_CM2 = result_XINJIANG_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新新疆移动记录
# 更新新疆移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_XINJIANG_CM2,
        "RecordType": record_type,
        "RecordLine": "新疆移动",
        "Value": ip2_XINJIANG_CM
    }
    req.from_json_string(json.dumps(params))
    resp_XINJIANG_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_XINJIANG_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 青海
# 青海联通
...
# 解析返回结果
ip1_QINGHAI_CU= result_QINGHAI_CU['Answer'][1]['data']
ip2_QINGHAI_CU= result_QINGHAI_CU['Answer'][2]['data']
# 获取青海联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_QINGHAI_CU2 = result_QINGHAI_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新青海联通记录
# 更新青海联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_QINGHAI_CU2,
        "RecordType": record_type,
        "RecordLine": "青海联通",
        "Value": ip2_QINGHAI_CU
    }
    req.from_json_string(json.dumps(params))
    resp_QINGHAI_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_QINGHAI_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 青海电信
# 获取青海电信 CDN 调度结果
...
# 解析返回结果
ip1_QINGHAI_CT= result_QINGHAI_CT['Answer'][1]['data']
ip2_QINGHAI_CT= result_QINGHAI_CT['Answer'][2]['data']
# 获取青海电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_QINGHAI_CT2 = result_QINGHAI_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新青海电信记录
# 更新青海电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_QINGHAI_CT2,
        "RecordType": record_type,
        "RecordLine": "青海电信",
        "Value": ip2_QINGHAI_CT
    }
    req.from_json_string(json.dumps(params))
    resp_QINGHAI_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_QINGHAI_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 青海移动
# 获取青海移动 CDN 调度结果
...
# 解析返回结果
ip1_QINGHAI_CM= result_QINGHAI_CM['Answer'][1]['data']
ip2_QINGHAI_CM= result_QINGHAI_CM['Answer'][2]['data']
# 获取青海移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_QINGHAI_CM2 = result_QINGHAI_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新青海移动记录
# 更新青海移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_QINGHAI_CM2,
        "RecordType": record_type,
        "RecordLine": "青海移动",
        "Value": ip2_QINGHAI_CM
    }
    req.from_json_string(json.dumps(params))
    resp_QINGHAI_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_QINGHAI_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 宁夏
# 宁夏联通
...
# 解析返回结果
ip1_NINGXIA_CU= result_NINGXIA_CU['Answer'][1]['data']
ip2_NINGXIA_CU= result_NINGXIA_CU['Answer'][2]['data']
# 获取宁夏联通记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_NINGXIA_CU2 = result_NINGXIA_CU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新宁夏联通记录
# 更新宁夏联通记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_NINGXIA_CU2,
        "RecordType": record_type,
        "RecordLine": "宁夏联通",
        "Value": ip2_NINGXIA_CU
    }
    req.from_json_string(json.dumps(params))
    resp_NINGXIA_CU2_Modify_Record = client.ModifyRecord(req)
    print(resp_NINGXIA_CU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 宁夏电信
# 获取宁夏电信 CDN 调度结果
...
# 解析返回结果
ip1_NINGXIA_CT= result_NINGXIA_CT['Answer'][1]['data']
ip2_NINGXIA_CT= result_NINGXIA_CT['Answer'][2]['data']
# 获取宁夏电信记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_NINGXIA_CT2 = result_NINGXIA_CT_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新宁夏电信记录
# 更新宁夏电信记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_NINGXIA_CT2,
        "RecordType": record_type,
        "RecordLine": "宁夏电信",
        "Value": ip2_NINGXIA_CT
    }
    req.from_json_string(json.dumps(params))
    resp_NINGXIA_CT2_Modify_Record = client.ModifyRecord(req)
    print(resp_NINGXIA_CT2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 宁夏移动
# 获取宁夏移动 CDN 调度结果
...
# 解析返回结果
ip1_NINGXIA_CM= result_NINGXIA_CM['Answer'][1]['data']
ip2_NINGXIA_CM= result_NINGXIA_CM['Answer'][2]['data']
# 获取宁夏移动记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_NINGXIA_CM2 = result_NINGXIA_CM_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新宁夏移动记录
# 更新宁夏移动记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_NINGXIA_CM2,
        "RecordType": record_type,
        "RecordLine": "宁夏移动",
        "Value": ip2_NINGXIA_CM
    }
    req.from_json_string(json.dumps(params))
    resp_NINGXIA_CM2_Modify_Record = client.ModifyRecord(req)
    print(resp_NINGXIA_CM2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 教育网
# 获取教育网 CDN 调度结果
...
# 解析返回结果
ip1_EDU= result_EDU['Answer'][1]['data']
ip2_EDU= result_EDU['Answer'][2]['data']
# 获取教育网记录ID
try:
    req = models.DescribeRecordListRequest()
    params = {
    ...
    RecordId_EDU2 = result_EDU_RecordId['RecordList'][1]['RecordId']
except TencentCloudSDKException as err:
    print(err)
# 更新教育网记录
# 更新教育网记录1
...
try:
    ...
    params = {
        "Domain": domain,
        "RecordId": RecordId_EDU2,
        "RecordType": record_type,
        "RecordLine": "教育网",
        "Value": ip2_EDU
    }
    req.from_json_string(json.dumps(params))
    resp_EDU2_Modify_Record = client.ModifyRecord(req)
    print(resp_EDU2_Modify_Record.to_json_string())
except TencentCloudSDKException as err:
    print(err)
# 默认
