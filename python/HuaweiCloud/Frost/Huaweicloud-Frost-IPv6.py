...
if __name__ == "__main__":
    ...
    # 获取 CDN 调度结果并将调度结果推送到 HuaweiCloud
    # 华北
    # 北京
    # 北京电信
    # 获取北京电信调度结果
    ...
    Dianxin_Beijing_CDN_result1 = Dianxin_Beijing_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
    ...
    Yidong_Beijing_CDN_result1 = Yidong_Beijing_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Beijing_CDN_result1 = Liantong_Beijing_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Tianjin_CDN_result1 = Dianxin_Tianjin_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Tianjin_CDN_result1 = Yidong_Tianjin_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Tianjin_CDN_result1 = Liantong_Tianjin_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Hebei_CDN_result1 = Dianxin_Hebei_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Hebei_CDN_result1 = Yidong_Hebei_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Hebei_CDN_result1 = Liantong_Hebei_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Shanxi_CDN_result1 = Dianxin_Shanxi_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Shanxi_CDN_result1 = Yidong_Shanxi_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Shanxi_CDN_result1 = Liantong_Shanxi_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Neimenggu_CDN_result1 = Dianxin_Neimenggu_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Neimenggu_CDN_result1 = Yidong_Neimenggu_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Neimenggu_CDN_result1 = Liantong_Neimenggu_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Liaoning_CDN_result1 = Dianxin_Liaoning_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Liaoning_CDN_result1 = Yidong_Liaoning_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Liaoning_CDN_result1 = Liantong_Liaoning_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Jilin_CDN_result1 = Dianxin_Jilin_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Jilin_CDN_result1 = Yidong_Jilin_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Jilin_CDN_result1 = Liantong_Jilin_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Heilongjiang_CDN_result1 = Dianxin_Heilongjiang_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Heilongjiang_CDN_result1 = Yidong_Heilongjiang_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Heilongjiang_CDN_result1 = Liantong_Heilongjiang_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Shaanxi_CDN_result1 = Dianxin_Shaanxi_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Shaanxi_CDN_result1 = Yidong_Shaanxi_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Shaanxi_CDN_result1 = Liantong_Shaanxi_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Gansu_CDN_result1 = Dianxin_Gansu_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Gansu_CDN_result1 = Yidong_Gansu_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Gansu_CDN_result1 = Liantong_Gansu_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Qinghai_CDN_result1 = Dianxin_Qinghai_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Qinghai_CDN_result1 = Yidong_Qinghai_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Qinghai_CDN_result1 = Liantong_Qinghai_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Ningxia_CDN_result1 = Dianxin_Ningxia_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Ningxia_CDN_result1 = Yidong_Ningxia_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Ningxia_CDN_result1 = Liantong_Ningxia_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Xinjiang_CDN_result1 = Dianxin_Xinjiang_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Xinjiang_CDN_result1 = Yidong_Xinjiang_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Xinjiang_CDN_result1 = Liantong_Xinjiang_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Henan_CDN_result1 = Dianxin_Henan_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Henan_CDN_result1 = Yidong_Henan_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Henan_CDN_result1 = Liantong_Henan_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Hubei_CDN_result1 = Dianxin_Hubei_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Hubei_CDN_result1 = Yidong_Hubei_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Hubei_CDN_result1 = Liantong_Hubei_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Hunan_CDN_result1 = Dianxin_Hunan_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Hunan_CDN_result1 = Yidong_Hunan_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Hunan_CDN_result1 = Liantong_Hunan_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Shanghai_CDN_result1 = Dianxin_Shanghai_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Shanghai_CDN_result1 = Yidong_Shanghai_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Shanghai_CDN_result1 = Liantong_Shanghai_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Jiangsu_CDN_result1 = Dianxin_Jiangsu_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Jiangsu_CDN_result1 = Yidong_Jiangsu_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Jiangsu_CDN_result1 = Liantong_Jiangsu_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Zhejiang_CDN_result1 = Dianxin_Zhejiang_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Zhejiang_CDN_result1 = Yidong_Zhejiang_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Zhejiang_CDN_result1 = Liantong_Zhejiang_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Anhui_CDN_result1 = Dianxin_Anhui_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Anhui_CDN_result1 = Yidong_Anhui_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Anhui_CDN_result1 = Liantong_Anhui_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Fujian_CDN_result1 = Dianxin_Fujian_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Fujian_CDN_result1 = Yidong_Fujian_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Fujian_CDN_result1 = Liantong_Fujian_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Jiangxi_CDN_result1 = Dianxin_Jiangxi_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Jiangxi_CDN_result1 = Yidong_Jiangxi_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Jiangxi_CDN_result1 = Liantong_Jiangxi_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Shandong_CDN_result1 = Dianxin_Shandong_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Shandong_CDN_result1 = Yidong_Shandong_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Shandong_CDN_result1 = Liantong_Shandong_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Guangdong_CDN_result1 = Dianxin_Guangdong_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Guangdong_CDN_result1 = Yidong_Guangdong_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Guangdong_CDN_result1 = Liantong_Guangdong_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Hainan_CDN_result1 = Dianxin_Hainan_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Hainan_CDN_result1 = Yidong_Hainan_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Hainan_CDN_result1 = Liantong_Hainan_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Guangxi_CDN_result1 = Dianxin_Guangxi_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Guangxi_CDN_result1 = Yidong_Guangxi_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Guangxi_CDN_result1 = Liantong_Guangxi_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Chongqing_CDN_result1 = Dianxin_Chongqing_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Chongqing_CDN_result1 = Yidong_Chongqing_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Chongqing_CDN_result1 = Liantong_Chongqing_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Sichuan_CDN_result1 = Dianxin_Sichuan_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Sichuan_CDN_result1 = Yidong_Sichuan_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Sichuan_CDN_result1 = Liantong_Sichuan_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Guizhou_CDN_result1 = Dianxin_Guizhou_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Guizhou_CDN_result1 = Yidong_Guizhou_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Guizhou_CDN_result1 = Liantong_Guizhou_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Yunnan_CDN_result1 = Dianxin_Yunnan_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Yunnan_CDN_result1 = Yidong_Yunnan_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Yunnan_CDN_result1 = Liantong_Yunnan_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Dianxin_Xizang_CDN_result1 = Dianxin_Xizang_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Yidong_Xizang_CDN_result1 = Yidong_Xizang_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Liantong_Xizang_CDN_result1 = Liantong_Xizang_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
    ...
    Jiaoyuwang_CDN_result1 = Jiaoyuwang_CDN_json['Answer'][0]['data']
    # 获取记录集ID
    try:
        request = ShowRecordSetByZoneRequest()
        request.zone_id = zone_id
